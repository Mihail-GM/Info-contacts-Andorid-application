...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //Open conntact activity
            Intent intent = new Intent(this, pageAllContacts.class);
    ...
    private void addNamessToAutoComplete(List<String> nameAddressCollection) {
